...
static struct OPNMIDI_AudioFormat g_audioFormat =
{
...
static struct OPN2_MIDIPlayer* playingDevice = NULL;
...
void infiniteLoopStream(struct OPN2_MIDIPlayer* device)
{
    if(mutex_created)
    {
...
#define OPN_DEV (struct OPN2_MIDIPlayer*)device

JNIEXPORT void JNICALL
Java_ru_wohlsoft_opnmidiplayer_PlayerService_startPlaying(
    JNIEnv *env,
    jclass instance,
    jlong device
)
{
    ...
    infiniteLoopStream(OPN_DEV);
}

JNIEXPORT void JNICALL
Java_ru_wohlsoft_opnmidiplayer_PlayerService_stopPlaying(
    JNIEnv *env,
    jclass instance
)
{
...
Java_ru_wohlsoft_opnmidiplayer_PlayerService_adl_1errorString(
    JNIEnv *env,
    jclass instance
)
{
...
JNIEXPORT jstring JNICALL
Java_ru_wohlsoft_opnmidiplayer_PlayerService_adl_1errorInfo(
    JNIEnv *env,
    jclass instance,
    jlong device
)
{
    ...
    pthread_mutex_lock(&g_lock);
    ret = (*env)->NewStringUTF(env, opn2_errorInfo(OPN_DEV));
    pthread_mutex_unlock(&g_lock);
...
JNIEXPORT jstring JNICALL
Java_ru_wohlsoft_opnmidiplayer_PlayerService_stringFromJNI(
    JNIEnv *env,
    jobject instance
)
{
    (void)instance;
    return (*env)->NewStringUTF(env, "OPN2 Emulator is ready");
}

JNIEXPORT jint JNICALL
Java_ru_wohlsoft_opnmidiplayer_PlayerService_adl_1setEmulator(
    JNIEnv *env,
    jclass instance,
    jlong device,
    jint emulator
...
JNIEXPORT jint JNICALL
Java_ru_wohlsoft_opnmidiplayer_PlayerService_adl_1setNumChips(
    JNIEnv *env,
    jclass instance,
    jlong device,
    jint numCards
)
{
    ...
    pthread_mutex_lock(&g_lock);
    ret = (jint)opn2_setNumChips(OPN_DEV, (int)numCards);
    pthread_mutex_unlock(&g_lock);
...
Java_ru_wohlsoft_opnmidiplayer_PlayerService_adl_1init(
    JNIEnv *env,
    jclass instance,
    jlong sampleRate
)
...
JNIEXPORT void JNICALL
Java_ru_wohlsoft_opnmidiplayer_PlayerService_adl_1setScaleModulators(
    JNIEnv *env,
    jclass instance,
    jlong device,
    jint smod
)
{
    (void)env; (void)instance;
    pthread_mutex_lock(&g_lock);
    opn2_setScaleModulators(OPN_DEV, (int)smod);
    pthread_mutex_unlock(&g_lock);
}

JNIEXPORT void JNICALL
Java_ru_wohlsoft_opnmidiplayer_PlayerService_adl_1setLoopEnabled(
    JNIEnv *env,
    jclass instance,
    jlong device,
    jint loopEn
)
{
    (void)env; (void)instance;
    pthread_mutex_lock(&g_lock);
    opn2_setLoopEnabled(OPN_DEV, (int)loopEn);
    pthread_mutex_unlock(&g_lock);
}
...
)
{
    ...
    ret = opn2_openBankFile(OPN_DEV, (char*)file);
...
JNIEXPORT jint JNICALL
Java_ru_wohlsoft_opnmidiplayer_PlayerService_adl_1openBankData(
    JNIEnv *env,
    jclass instance,
    jlong device,
    jbyteArray array_
)
{
    ...
    ret = opn2_openBankData(OPN_DEV, array, length);
...
JNIEXPORT jint JNICALL
Java_ru_wohlsoft_opnmidiplayer_PlayerService_adl_1openFile(
    JNIEnv *env,
    jclass instance,
    jlong device,
    jstring file_
)
{
    ...
    pthread_mutex_lock(&g_lock);
    file = (*env)->GetStringUTFChars(env, file_, NULL);
    ret = opn2_openFile(OPN_DEV, (char*)file);
    (*env)->ReleaseStringUTFChars(env, file_, file);
    pthread_mutex_unlock(&g_lock);
...
JNIEXPORT jint JNICALL
Java_ru_wohlsoft_opnmidiplayer_PlayerService_adl_1openData(
    JNIEnv *env,
    jclass instance,
    jlong device,
    jbyteArray array_
)
{
    ...
    array = (*env)->GetByteArrayElements(env, array_, NULL);
    length =  (*env)->GetArrayLength(env, array_);
    ret = opn2_openData(OPN_DEV, array, (unsigned long)(length));
    (*env)->ReleaseByteArrayElements(env, array_, array, 0);
    pthread_mutex_unlock(&g_lock);
...
JNIEXPORT void JNICALL
Java_ru_wohlsoft_opnmidiplayer_PlayerService_adl_1reset(
    JNIEnv *env,
    jclass instance,
    jlong device
)
...
JNIEXPORT void JNICALL
Java_ru_wohlsoft_opnmidiplayer_PlayerService_adl_1close(
    JNIEnv *env,
    jclass instance,
    jlong device
)
...
JNIEXPORT jint JNICALL
Java_ru_wohlsoft_opnmidiplayer_PlayerService_adl_1play(
    JNIEnv *env,
    jclass instance,
    jlong device,
    jshortArray buffer_
)
{
    ...
    outBuff = (short*)(buff);
    gotSamples = opn2_play(OPN_DEV, length, outBuff);
...
Java_ru_wohlsoft_opnmidiplayer_PlayerService_adl_1positionTell(
    JNIEnv *env,
    jclass instance,
    jlong device
)
{
    ...
    pthread_mutex_lock(&g_lock);
    ret = (jdouble)(opn2_positionTell(OPN_DEV));
    pthread_mutex_unlock(&g_lock);
...
JNIEXPORT jdouble JNICALL
Java_ru_wohlsoft_opnmidiplayer_PlayerService_adl_1totalTimeLength(
    JNIEnv *env,
    jclass instance,
    jlong device
)
{
    ...
    pthread_mutex_lock(&g_lock);
    ret = (jdouble)opn2_totalTimeLength(OPN_DEV);
    pthread_mutex_unlock(&g_lock);
...
JNIEXPORT void JNICALL
Java_ru_wohlsoft_opnmidiplayer_PlayerService_adl_1positionSeek(
    JNIEnv *env,
    jclass instance,
    jlong device,
    jdouble seconds
)
{
    ...
    pthread_mutex_lock(&g_lock);
    opn2_positionSeek(OPN_DEV, (double)seconds);
    pthread_mutex_unlock(&g_lock);
}

JNIEXPORT void JNICALL
Java_ru_wohlsoft_opnmidiplayer_PlayerService_adl_1setVolumeRangeModel(
    JNIEnv *env,
    jclass instance,
    jlong device,
    jint volumeModel
...
)
{
    ...
    pthread_mutex_lock(&g_lock);
    ret = (jint)opn2_setRunAtPcmRate(OPN_DEV, (int)enabled);
    pthread_mutex_unlock(&g_lock);
...
JNIEXPORT void JNICALL
Java_ru_wohlsoft_opnmidiplayer_PlayerService_adl_1setSoftPanEnabled(
    JNIEnv *env,
    jobject instance,
    jlong device,
    jint enabled
